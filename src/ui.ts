...
export const STYLES = `
  ...
  *{box-sizing:border-box}
  ...
  /* keep anchored sections clear of the sticky header (no "đè") */
  section[id], main[id], [id="story"], [id="setup"], [id="uses"], [id="how"], [id="included"], [id="plays"], [id="skill"], [id="technique"], [id="start"], [id="demo"]{scroll-margin-top:88px}
